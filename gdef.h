...
#define FREELISTMAX 512
#ifndef IMG_BUILD
#define MemoryBlockSize 32768 // 140kb
#else
#define MemoryBlockSize 32768
#endif
#define ObjectTableMax 4000 // objects
...
extern object memoryBlock[];
extern object objectFreeList[];
extern object symbols;
extern int currentMemoryPosition;
#endif
